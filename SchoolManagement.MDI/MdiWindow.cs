...
namespace Hammer.MDIContainer.Control
{
    ...
    public sealed class MdiWindow : ContentControl
    {
        ...
        public int ParentSelectedIndex
        {
            get { return parentSelectedIndex; }
            set { parentSelectedIndex = value; }
        }
        ...
        private void OnContainerSizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            if (WindowState == WindowState.Minimized)
            {
                ...
                if (this.Title.Length > 5) this.Title = this.Title.Substring(0, 4);
            }
        }
        ...
        public void ToggleMinimizeWindow(object sender, RoutedEventArgs e)
        {
            Focus();
            this.ToggleMinimize();
        }

        public void ToggleRestoreWindow()
        {
            Focus();
            this.ToggleRestore();
        }
